...
class refwin extends StatefulWidget {
  refwin({Key key, this.datalist, this.index}) : super(key: key);
  final int index;
  final StoreData datalist;
  @override
  _refwinState createState() => _refwinState();
}

class _refwinState extends State<refwin> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Ask for Reference'),
      ),
      body: Container(
        child: Column(
          ...
          children: [
            ...
            Text("Name" + widget.datalist.cname[widget.index]),
            Text("Address" + widget.datalist.cname[widget.index]),
          ],
        ),
      ),
    );
...
class _memberState extends State<member> {
  ...
  openrefwin(StoreData datalist, int index) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => refwin(datalist: datalist, index: index)));
  }
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          ...
                          onTap: () => openrefwin(_storeData, index),
